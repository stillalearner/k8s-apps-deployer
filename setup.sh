...
echo "   k8sdeploy list"
echo "   # or: python -m k8sdeployer.cli list"
echo ""
echo "3. Deploy an application (example):"
echo "   k8sdeploy deploy basic-pod -n basic-pod -v"
echo "   k8sdeploy deploy mysql -n database -v"
echo ""
echo "4. Validate deployment:"
echo "   k8sdeploy validate basic-pod -n basic-pod"
echo ""
echo "5. Remove application:"
echo "   k8sdeploy remove basic-pod -n basic-pod"
echo ""
